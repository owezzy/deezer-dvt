...
@Component({
  ...
  template: ` <app-selected-artist-page></app-selected-artist-page> `,
  styles: [],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class ViewArtistPageComponent implements OnDestroy {
  ...
  ngOnDestroy() {
    return this.actionsSubscription.unsubscribe();
  }
}
